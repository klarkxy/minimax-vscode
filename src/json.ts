...
/**
 * `JSON.stringify` that replaces lone surrogates with U+FFFD.
 * Required because some upstream providers reject otherwise well-formed
 * strings that happen to contain a single UTF-16 surrogate code unit.
 */
